...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = os.getenv('EMAIL_HOST_USER')  # Email desde el cual se envían los correos
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD') # Contraseña o contraseña de aplicación